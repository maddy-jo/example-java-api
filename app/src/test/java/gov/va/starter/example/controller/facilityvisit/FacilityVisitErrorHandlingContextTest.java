...
class FacilityVisitErrorHandlingContextTest {
  ...
  private FacilityVisitRequest request =
      new FacilityVisitRequest(
          defaultFacilityVisit.getUserName(),
          defaultFacilityVisit.getPii(),
          defaultFacilityVisit.getFirstName(),
          defaultFacilityVisit.getLastName());
  private FacilityVisit model =
      new FacilityVisit(
          defaultFacilityVisit.getUserName(),
          defaultFacilityVisit.getPii(),
          defaultFacilityVisit.getFirstName(),
  ...
  void whenResourceNotRetrieved_thenReturns404() throws Exception {
    ...
    MockHttpServletResponse response =
        mockMvc
            .perform(
                get("/v1/example/facilityvisits/foo")
